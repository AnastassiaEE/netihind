...
export default function bgPhoto({ src }: { src: StaticImageData }) {
    return (
        <div className="relative z-0">
            ...
            <div className="bg-gradient-to-br from-primary from-10% via-secondary to-accent to-60% rounded-3xl absolute bottom-0 left-1/2 -translate-x-1/2 w-[90%] h-[90%]"></div>
