...
const rightLineStyle = `md:after:bg-neutral\
 md:after:absolute\
 md:after:left-2/4\
 md:after:top-10\
 md:after:w-2/4\
...
const leftLineStyle = `md:before:bg-neutral\
 md:before:absolute\ 
 md:before:left-0\
 md:before:top-10\
 md:before:w-2/4\
...
const bottomLineStyle = `after:bg-neutral\
 after:absolute\
 after:left-10\
 after:top-2/4\
 after:w-px\
...
const topLineStyle = `before:bg-neutral\
 before:absolute\
 before:left-10\
 before:top-0\
 before:w-px\
