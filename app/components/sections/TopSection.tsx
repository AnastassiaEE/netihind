...
export default function TopSection() {
    return(
        <section className="h-screen max-md:flex max-md:items-center md:relative bg-gradient-to-tl from-indigo-500/10 from-0% via-violet-500/10 via-20% via-fuchsia-500/10 to-70%">
            <MeshSvg>
