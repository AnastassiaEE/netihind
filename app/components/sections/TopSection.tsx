    ...
    return(
        <SectionLayout className={sectionStyle} bg={bg}>
            ...
            <div className="lg:w-10/12 md:-translate-y-16">
                <h1 className="max-md:text-[calc(1.475rem+2.7vw)] md:text-5xl !leading-snug font-extrabold mb-4"> Поиск <span className="bg-clip-text text-transparent bg-gradient-to-r from-primary via-secondary to-accent">провайдеров</span> домашнего интернета по адресу </h1>
